...
const BulkDeleteConfirmationModal = ({ isOpen, onClose, onConfirm, count, isLoading = false }) => {
            ...
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 className="text-lg leading-6 font-medium text-gray-900">
                  Delete {count} Stylist{count > 1 ? "s" : ""}
                </h3>
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Are you sure you want to delete {count} selected stylist{count > 1 ? "s" : ""}?
                    This action cannot be undone and will permanently remove:
                  </p>
                  <ul className="mt-2 text-xs text-red-600 space-y-1 list-disc list-inside">
                    <li>All associated stylist accounts</li>
                    <li>All products created by these stylists</li>
                    <li>All orders from these stylists</li>
                  ...
                  <div className="mt-3 p-3 bg-red-50 rounded-md">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium text-red-800">
                        This is a critical action and cannot be reversed!
                      </span>
                    </div>
                  </div>
                </div>
